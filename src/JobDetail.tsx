...
function ResumeAnalysisView({ analysis, onOpenTrack, onUpdate, onAddGaps }: { analysis: StoredAnalysisDto; onOpenTrack: (id: string) => void; onUpdate: (s: Suggestion, state: 'saved' | 'dismissed' | 'completed' | null) => void; onAddGaps: (trackIds: string[]) => void }) {
